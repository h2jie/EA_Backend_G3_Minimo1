...
import tagRoutes from './modules/tag/tag_routes.js'; // Nota el .js al final
...
const swaggerOptions = {
    definition: {
        ...
        tags: [
            ...
            },
            {
                ...
                name: 'Tags',
                description: 'Rutas relacionadas con la gestión de etiquetas',
            }
          ],
        servers: [
            {
    ...
    apis: ['./modules/users/*.js', './modules/gyms/*.js', './modules/combats/*.js','./modules/tag/*.js'] // Asegúrate de que esta ruta apunta a tus rutas
};
